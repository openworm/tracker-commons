# -*- coding: utf-8 -*-
"""
Created on Sun Dec 13 00:41:55 2015
...
class WCONTimeSeriesData(pd.DataFrame):
    #======================================================
    # TODO: PLEASE CONSIDER MOVING ALL THE BELOW TO ANOTHER CLASS
    # (it will have to inherit from pd.DataFrame)
